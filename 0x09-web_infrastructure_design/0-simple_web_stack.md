...
+ What is a server
  ...
  server process requests and deliver data to another computer over the internet or a local network. 
...
+ What is the role of the application server
  Apllication server is API between data server and client user, it takes user request  
  and access the data server, get the data that user need, rendering webpages then  
  return back to user.
